...
function generatePDF($conn)
{
   ...
   while ($fetch_orders = $select_orders->fetch(PDO::FETCH_ASSOC)) {
       $pdf->Cell(40, 10, $fetch_orders['user_id'], 1);
       $pdf->Cell(40, 10, $fetch_orders['placed_on'], 1);
       $pdf->Cell(40, 10, $fetch_orders['name'], 1);
       $pdf->Cell(40, 10, $fetch_orders['email'], 1);
       $pdf->Cell(40, 10, $fetch_orders['number'], 1);
       $pdf->Cell(40, 10, $fetch_orders['address'], 1);
       $pdf->Cell(40, 10, $fetch_orders['total_products'], 1);
       $pdf->Cell(40, 10, 'LKR' . $fetch_orders['total_price'], 1);
       $pdf->Ln();
   }

   $pdf->Output('order_list.pdf', 'D');
